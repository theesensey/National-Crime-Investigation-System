...
<table id="myTable">
    ...
    <?php
    $sql="SELECT * FROM cases WHERE crimetype='HOMICIDE'";
...
<tr>
    ...
    <td>'.$remarks.'</td>
    <td>
    <button><a href="../homicide/updatecasechanges.php? updateid='.$id.'">Update</a></button>
</td>
</tr>
';}
}
    ?>
</table><br><a href="index.php">Back to Home</a><br>
        </div>
        </div>
    </div>
        </div>
