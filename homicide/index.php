            ...
            <div class="main_content">
                ...
                <div class="info">
                    ...
                    <a href="viewofficers.php">
                        <button class="submitbtn">View All Homicide Officers</button>
                    </a>
                    <a href="viewcrimes.php">
                        <button class="submitbtn">View All  Crimes</button>
                    </a>
                    <a href="viewcasesall.php">
                        <button class="submitbtn">View All  Cases</button>
                    </a>

                    <a href="viewhomicidecases.php">
                        <button class="submitbtn">View All Homicide Cases</button>
                    </a>
                </div>
            </div>
        </div>
