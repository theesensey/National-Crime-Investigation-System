            ...
            <div class="main_content">
                ...
                <div class="info">
                    ...
                    <a href="viewcrimes.php">
                        <button class="submitbtn">View All Theft Crimes</button>
                    </a>
                    <a href="viewtheftcases.php">
                        <button class="submitbtn">View All Theft Cases</button>
                    </a>
                    <a href="filterstatus.php">
                        <button class="submitbtn">Reports Based On Case Status</button>
                    </a>
                    <a href="filterotype.php">
                        <button class="submitbtn">Reports On Crime Type</button>
                    </a>
                </div>
            </div>
        </div>
