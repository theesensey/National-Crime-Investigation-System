...
<td>'.$comments.'</td>
<td>
<button><a href="../ocpd/updatecrimechanges.php? updateid='.$id.'">Update</a></button>
<button><a href="../ocpd/deletecrime.php? deleteid='.$id.'">Delete</a></button> 
</td>
</tr>
';}
