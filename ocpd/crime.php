...
if ($result) { 
    header("refresh:80;url=../ocpd/viewcrimes.php"); // Refreshes after 20 seconds and Redirects
    echo "<script>
...
$userrow=mysqli_fetch_assoc($usersdata);
...
<head>
    ...
    <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link rel="shortcut icon" href="../Arms.ico">
</head>
