...
if($result){
    //Log message
    $log= " ".$_SESSION['user']." made changes to case $id ";
   ...
   //after update redirects to table view
    header("refresh:5;url=../ocpd/updatecaseview.php");
    echo "<script>
    ...
    <div class="wrapper">
        ...
        <div class="main_content">
            ...
            <form id="form1" method="post" onsubmit="return validate()" >
                        ...
                        <button class="btnres" type="clear">Reset</button>
                        <a href="updatecaseview.php">Back to Update Case </a><br>
                        </div>
