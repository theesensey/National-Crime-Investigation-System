...
<body>
    <div class="wrapper">
        ...
        <div class="main_content">
            <div class="main_content">
                <div class="top">
                    <H2>Crime Update <a href="update.php">Back to Update</a></H2>
                </div>
                    <div class="info">
                    <div class="tabsort">
<table id="myTable">
    ...
    <?php
    $sql="SELECT * FROM cases WHERE crimetype='THEFT'";
...
<tr>
    ...
    <td>'.$remarks.'</td>
    <td>
    <button><a href="../thefthead/updatecasechanges.php? updateid='.$id.'">Update</a></button>
</td>
</tr>
';}
}
