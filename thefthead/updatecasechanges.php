...
$sql="UPDATE cases SET  occurrenceId='$occurrenceId',stationCode='$stationCode',
                        officerId='$officerId',casename='$casename',crimetype='$crimetype',
                        casestatus='$casestatus',allocationDate='$allocationDate',remarks='$remarks'
WHERE id=$id";
...
if($result){
    //Log message
    $log= " ".$_SESSION['user']." made changes to Case ID: $id ";

    ncislogs($log); 
   // echo "Updated successfully";
   //after update redirects to table view
    header("refresh:80;url=../genderhead/updatecaseview.php");
    echo "<script>
    ...
    <div class="wrapper">
        ...
        <div class="main_content">
            ...
            <form id="form1" method="post" onsubmit="return validate()" >
                        ...
                        <br>
                        <input type="number" class="form-control" name="occurrenceId" placeholder="Occurence ID number" value="<?php echo $occurrenceId; ?>">
                        <br><br>
                            </div>
                        </div>
                        <br>
                        ...
                        <br>
                        <input id="stationcode" type="text" class="form-control" name="stationCode" placeholder="Current Station Code" value="<?php echo $stationCode; ?>">
                        <br><br>
                            </div>
                            <br>
                            <div class="field">
                        ...
                        <br>
                        <input type="number" class="form-control" name="officerId" placeholder="Officer to be allocated" value="<?php echo $officerId;?>">
                        <br><br>
                            </div>
                        </div>
                        <br>
                        ...
                        <br>
                        <input type="text" class="form-control" placeholder="DD-MM-YYYY"  name="allocationDate" value="<?php echo $allocationDate; ?>">
                        <br><br>
                            </div>
                            <br>
                        ...
                        <a href="updatecaseview.php">Back to Update/Delete</a><br>
                        </div>
